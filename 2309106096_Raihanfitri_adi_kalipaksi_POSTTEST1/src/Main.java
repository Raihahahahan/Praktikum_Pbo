...
public class Main {
    static final int MAX_BARANG = 100;
    static final int MAX_PENGIRIMAN = 100;
    static final int MAX_PEMBAYARAN = 100;
    static final int MAX_CUSTOMERS = 100;
    static final int MAX_DRIVERS = 100;  
    ...
    public static void kirimBarang() {
        ...
        System.out.println("Barang berhasil dikirim!");
        System.out.println("ID Barang: " + newBarang.getId_barang());
        System.out.println("Nama Barang: " + newBarang.getNama());
        System.out.println("Alamat Asal: " + newBarang.getAlamat_asal());
        System.out.println("Alamat Tujuan: " + newBarang.getAlamat_tujuan());
    ...
    public static void batalkanPesanan() {
        ...
        if (!adaPengiriman) {
            System.out.println("Tidak ada pengiriman yang bisa dibatalkan.");
            return;
        }
    ...
    public static void lakukanPembayaran() {
        ...
        for (int i = 0; i < pengirimanCount; i++) {
            ...
            if (pengiriman.getStatus_pengiriman().equals("ongoing")) {
                ...
                System.out.println("ID Barang: " + pengiriman.getId_barang());
                System.out.println("Status: " + pengiriman.getStatus_pengiriman());
                System.out.println("Harga: " + pengiriman.getHarga());
                System.out.println("Tanggal Pengiriman: " + pengiriman.getTanggal_pengiriman());
                System.out.println("------------------------------");
            }
        }
        ...
        if (!adaPengiriman) {
            System.out.println("Tidak ada pengiriman yang bisa dibayar.");
            return;
        }
    ...
    public static void validasiDriver() {
        ...
        for (int i = 0; i < driverCount; i++) {
            ...
            if (!driver.isStatus()) {
                adaDriver = true;
                System.out.println("ID Driver: " + driver.getId_driver());
        ...
        for (int i = 0; i < driverCount; i++) {
            Driver driver = drivers[i];
            if (driver.getId_driver() == id_driver) {
    ...
    public static void registerCustomer() {
        ...
        System.out.println("ID Customer: " + newCustomer.getId_customer());
    ...
    public static void registerDriver() {
        ...
        System.out.println("ID Driver: " + newDriver.getId_driver());
    ...
    public static void ubahStatusPengirimanDriver() {
        ...
        System.out.print("Masukkan ID Pengiriman yang ingin diubah statusnya: ");
        int id_pengiriman = scanner.nextInt();
        scanner.nextLine();
        System.out.println("Pilih Metode Pembayaran:");
        System.out.println("1. Cash");
    ...
    public static void lihatDaftarDriver() {
        ...
        System.out.println("==============================");
        System.out.println("|      Daftar Driver         |");
        System.out.println("==============================");
    
        if (driverCount == 0) {
            System.out.println("Tidak ada driver yang terdaftar.");
            return;
        }
        ...
        for (int i = 0; i < driverCount; i++) {
            ...
            System.out.println("Plat Kendaraan: " + driver.getPlat_kendaraan());
            System.out.println("Nama Kendaraan: " + driver.getNama_kendaraan());
            System.out.println("Status: " + (driver.isStatus() ? "Aktif" : "Menunggu Validasi"));
            System.out.println("------------------------------");
        }
    ...
    public static void loginCustomer() {
        ...
        for (int i = 0; i < customerCount; i++) {
            ...
            if (customer.getNama().equals(nama) && customer.getPassword().equals(password)) {
                System.out.println("Login Berhasil!");
                System.out.println("Selamat Datang, " + customer.getNama() + "!");
                session_user = customer.getId_customer();
                menuCustomer();
                return;
            }
        }
    ...
    public static void loginDriver() {
        ...
        for (int i = 0; i < driverCount; i++) {
            Driver driver = drivers[i];
            if (driver.getNama().equals(nama) && driver.getPassword().equals(password)) {
                if (!driver.isStatus()) {
                    System.out.println("Akun Anda masih menunggu konfirmasi.");
                } else {
                    System.out.println("Login Berhasil!");
                    System.out.println("Selamat Datang, " + driver.getNama() + "!");
                    session_user = driver.getId_driver();
                    menuDriver();
                }
                return;
            }
